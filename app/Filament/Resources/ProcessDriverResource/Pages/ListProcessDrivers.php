...
class ListProcessDrivers extends ListRecords
{
    use HasTableFilters;
...
;
    ...
    protected function getNameColumn(): Column
    {
        return TextColumn::make('name')
            ->label(__('admin/process_driver.columns.name'))
            ->sortable()
            ->searchable();
    }
    ...
    protected function getIntroColumn(): Column
    {
        return TextColumn::make('intro')
            ->label(__('admin/process_driver.columns.intro'))
            ->limit(60)
            ->searchable();
    }
    ...
    protected function getCreatedAtColumn(): Column
    {
        return TextColumn::make('created_at')
            ->label(__('admin/process_driver.columns.created_at'))
            ->sortable()
            ->alignCenter()
            ->dateTime();
    }

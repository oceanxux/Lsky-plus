...
import PhotoAdapter from "@/components/PhotoSelector/PhotoBox.vue";
import {FontAwesomeIcon} from "@fortawesome/vue-fontawesome";
import {type UserPhotoGroup, usePhotoSelectorStore} from "@/stores/photo";
...
const { t } = useI18n()
const {toggleSelectAllByGroup} = usePhotoSelectorStore()
...
const rowConstraints = (containerWidth: number): RowConstraints => {
  let maxPhotos, singleRowMaxHeight = 220
...
<template>
  <div class="flex flex-col space-y-2">
    <div class="sticky top-0 z-[3] py-2 bg-gray-50 dark:bg-[var(--n-color)] flex space-x-2 items-center overflow-hidden group text-md">
      <FontAwesomeIcon
